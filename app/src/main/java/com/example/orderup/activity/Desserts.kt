...
import com.example.orderup.databinding.DessertsBinding
...
class Desserts : Fragment() {
    ...
    private var _binding: DessertsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DessertsBinding.inflate(inflater, container, false) // Correct binding class name
        return binding.root
